"""
DroneZone Team One:  Fall 2021 CPS 410
flystick - original python2 script to control an RC plane with a USB joystick.
...
"""
#from flystick_config import (CHANNELS, DISPLAY, DISPLAY_BRIGHTNESS, PPM_OUTPUT_PIN)
from flystick_config import (CHANNELS, PPM_OUTPUT_PIN)
